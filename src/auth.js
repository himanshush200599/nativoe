...
render(){
            ...
            <div>
              <div>
                ...
                <nav className="navbar navbar-expand-lg navbar-light navBorder">
                    ...
                    <div className="collapse navbar-collapse d-none d-xl-inline" id="navbarSupportedContent">
                      <div className="form-inline my-2 my-lg-0 ml-auto" >
                        <input className="form-control d-none d-xl-inline mr-2" ref='email' id='email' type="email" placeholder="Username" aria-label="Search" />
                        <input className="form-control  d-none d-xl-inline mr-2" ref = 'password' id='pass'  type="password" placeholder="Password" aria-label="Search" />


                        <button className="btn btn-primary my-2 my-sm-0 d-none d-xl-inline " id='login' type="submit" onClick={this.login}>Login</button>
  ...
  <div className='row d-none d-xl-flex'>
    ...
    <div className =' col-lg-4'>
       ...
       <div className='form'>
         ...
         <div className="form-group">
           ...
           <input type="tel" ref='mobile' className="form-control" id="number" placeholder="Mobile No"/>
         </div>
    ...
    <div className='offer'>
      ...
      <div id='mobileBox' className='d-xl-none'>
  <div className='form'>
    ...
    <div className="form-group">
      ...
      <input className="form-control " ref='email' id='email1' type="email" placeholder="Username" aria-label="Search" />


    </div>
    <div className="form-group">

    <input className="form-control " ref = 'password' id='pass1'  type="password" placeholder="Password" aria-label="Search" />
    </div>
<div>
